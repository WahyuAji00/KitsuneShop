                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('login') }}" class="form-group">
                            ...
                            <div class="d-flex justify-content-center login">
                                <button type="submit" class="btn fw-bold btn-login" style="background-color: #ff602bdb"><span>Login</span></button>
                            </div>
                        </form>
                    </div>
                    <div class="card-footer text-center">
                        <span>Don't have an account? </span><a href="{{ route('register') }}" style="text-decoration: none; color: rgb(4, 0, 255);">Register here</a>
                    </div>
                </div>
            </div>
        </div>
